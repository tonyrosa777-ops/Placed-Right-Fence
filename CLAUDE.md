...
Never embed third-party redirects that take users off the placedrightfence.com domain.
...
Custom multi-step estimate form → email/phone lead delivery (no CRM; confirm exact tool before Phase 4). Every extra click costs conversions. Every domain redirect
costs trust.

## SEO Rule
Every page must include: semantic HTML5 structure, unique title tag, meta
description, Open Graph tags, LocalBusiness (HomeAndConstructionBusiness → Contractor) schema markup, crawlable text
