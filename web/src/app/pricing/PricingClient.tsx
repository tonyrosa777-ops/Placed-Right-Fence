...
const TIERS = [
  {
    ...
    notIncluded: [
      "3-step visual estimate form",
      "Fence Finder Quiz (lead capture wizard)",
      "SEO blog",
      "Photo gallery",
...
const COMPARISON = [
  ...
  { label: "Basic estimate form → phone/email delivery", starter: true, growth: true, premium: true },
  ...
  { label: "3-step visual estimate form", starter: false, growth: true, premium: true },
  { label: "Fence Finder Quiz (lead capture wizard)", starter: false, growth: true, premium: true },
